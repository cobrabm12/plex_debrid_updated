...
settings_list = [
    ['Content Services', [
        ...
        setting('Plex users', ['Please provide a name for this Plex user: ',
                                'Please visit https://plex.tv/link and enter this code: '], content.services.plex, 'users', entry="user",
                help="Please link your Plex account. You will be asked to visit https://plex.tv/link and enter a code.",
                hidden=True, oauth=True),
